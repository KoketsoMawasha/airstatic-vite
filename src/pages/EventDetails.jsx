...
function EventDetails() {
  ...
  return (
    <div className='bg-neutral-900 w-[100vw] min-h-screen flex flex-col'>
      ...
      <div className='content w-screen flex flex-col self-start px-4 sm:self-center max-w-sm'>
        ...
        <div className="flex flex-start justify-start items-center">
          ...
          <div className="event-ticket p-4 w-full bg-sky-500 text-center rounded-md sticky bottom-0">
